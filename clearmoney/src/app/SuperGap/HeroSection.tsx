    ...
    <div className="bg-gradient-to-tr from-emerald-100 to-emerald-300 p-6 pb-20 min-h-[calc(100dvh-4rem)] flex flex-col justify-center items-center">
      <div className="mt-24 flex flex-col items-center justify-center p-10">
        <motion.div
          ...
          className="flex rounded-full ring-4 ring-emerald-950/20 border border-[#4FB3B8]/30 bg-emerald-600 w-24 h-24 justify-center items-center mb-5"
        >
          <Superannuation responsiveSizing="w-full h-full" />
        </motion.div>
        <h2 className="text-5xl lg:text-6xl text-emerald-950 font-extrabold tracking-tight drop-shadow-sm leading-[1.1] text-center">
          The Super Gap
          <br />
          <span className="text-emerald-600">is real</span>
        </h2>

        <h3 className="text-center font-medium text-emerald-900 xs:text-[1rem] sm:text-[1.5rem] max-w-xl mt-5">
