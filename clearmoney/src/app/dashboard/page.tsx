        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="flex w-full justify-start items-start">
              <span className="inline-block bg-amber-100 border-2 border-amber-300 text-amber-800 text-sm font-semibold px-3 py-2 mb-6 rounded-xl">
                Behind The Balance
              </span>
            </div>
            ...
            <div className="w-full flex justify-start items-center">
              <motion.button
                whileTap={{ scale: 0.95 }}
                className="border-4 border-emerald-600 hover:fill-[#F59E0B] text-emerald-700 px-7 py-3 text-base font-bold rounded-2xl hover:bg-emerald-50 hover:border-[#F59E0B] hover:text-[#F59E0B] hover:scale-105 transition-all shadow-sm"
              >
                <Link
                  href={"/holdings"}
                ...
                >
                  <p>Start Exploring</p>
                  <Search responsiveSizing="w-[1.5rem] h-[1.5rem]" />
                </Link>
              </motion.button>
            </div>
          </motion.div>
      ...
      <div className="bg-slate-50 py-32 border-t border-slate-200/60">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col items-center text-center mb-16">
            <span className="text-sm text-orange-600 border-2 border-orange-300 bg-orange-100 font-semibold px-3 py-2 mb-6 rounded-xl">
              Tools & Calculators
            </span>
            <h2 className="font-extrabold text-2xl lg:text-5xl text-slate-900">
              Calculators that Feel <span className="text-teal-600">Human</span>
            </h2>
          </div>
