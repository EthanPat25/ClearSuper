              ...
              <ul className="flex flex-col gap-2 w-full">
                {components.map((component) => (
                  ...
                  >
                    <li
                      key={component.title}
                      className="group flex items-start gap-4 rounded-xl p-3 transition-all duration-200 hover:bg-slate-100 hover:shadow-sm text-emerald-950"
                    >
                      <div className="flex items-center justify-center rounded-lg">
                        <div className="flex justify-center items-center rounded-[1.1rem] h-[4rem] w-[4rem] bg-emerald-100 transition-transform duration-200 group-hover:scale-105">
                      ...
                      <div className="flex flex-col flex-1 gap-[0.3rem]">
                        <div className="flex items-center">
                          <p className="text-[0.95rem] font-[500] text-gray-900 transition-colors group-hover:text-amber-500">
                            {component.title}
                          </p>
                          <ChevronRight className="ml-1 h-5 w-5 text-emerald-950 transition-all duration-200 group-hover:text-amber-500 group-hover:translate-x-1" />
                        </div>
