...
const SearchBar = () => {
  const [companyMode, setCompanyMode] = React.useState("company");
  ...
  return (
    <motion.div
      ...
      className="w-[60rem] bg-white shadow-sm border border-gray-200 rounded-2xl px-4 sm:px-6 py-3 flex flex-col gap-3"
    >
      <div className="flex items-center justify-between w-full">
        {/* Left empty spacer */}
        {/* Left side: Toggle */}
        <div className="flex-1">
          {/* Changed bg to gray-100/50 for a lighter feel */}
        ...
        <div className="flex items-center gap-3 justify-center">
          <button className="rounded-full p-2 bg-slate-200 hover:bg-slate-300 hover:scale-105 transition">
            <IconArrowNarrowLeft size={18} />
          </button>

          <h3 className="text-xs sm:text-sm text-gray-500"></h3>
